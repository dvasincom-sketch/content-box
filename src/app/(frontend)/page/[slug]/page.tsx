...
const LEGAL_STUBS: Record<string, { title: string; sections: { h: string; p: string }[] }> = {
  offer: {
    ...
    sections: [
      { h: '1. Общие положения', p: 'Настоящий документ является публичной офертой и определяет условия предоставления доступа к материалам проекта COCO JAMBO, а также условия добровольной поддержки проекта.' },
  ...
  terms: {
    ...
    sections: [
      { h: '1. Общие условия', p: 'Используя сайт COCO JAMBO, пользователь соглашается с условиями настоящего соглашения. Проект создан фанатами для русскоязычного сообщества ARMY.' },
