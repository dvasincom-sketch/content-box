...
export const SiteSettings: CollectionConfig = {
  ...
  fields: [
    ...
    {
      // Сквозные модераторы чата трансляций — массив id подписчиков.
      // Применяется ко всем трансляциям тенанта.
      name: 'streamModeratorIds',
      type: 'json',
      label: 'Модераторы чата трансляций (id подписчиков)',
      admin: { description: 'Общий список модераторов для всех трансляций. Настраивается из раздела «Трансляции».' },
    },
    {
