 ...
 * Одно видео принадлежит одной папке (поле `folder` в Videos), либо ни одной.
 *
 ...
 */
export const VideoFolders: CollectionConfig = {
  slug: 'video-folders',
  labels: { singular: 'Папка видео', plural: 'Папки видео' },
  admin: {
    useAsTitle: 'title',
